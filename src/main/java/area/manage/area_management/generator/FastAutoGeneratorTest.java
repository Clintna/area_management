package area.manage.area_management.generator;
...
public class FastAutoGeneratorTest {
    ...
    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG = new DataSourceConfig
            .Builder("jdbc:mysql://127.0.0.1:3306/bh_plan_manage?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2b8", "root", "root");
...
//                            .enableSwagger()     //开启 swagger 模式
                ...
                .packageConfig(builder -> {
                    builder.parent("area.manage.area_management")     //父包名
